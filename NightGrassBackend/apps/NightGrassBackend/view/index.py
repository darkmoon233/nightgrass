...
from NightGrassBackend.apps.utils import get_abs_dir
from NightGrassBackend.apps.utils.constants import METHODTYPE

index = Blueprint('index', __name__, url_prefix='/NightGrassBackend/',
